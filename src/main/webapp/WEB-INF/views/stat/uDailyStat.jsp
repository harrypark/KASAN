	            ...
	            <div class="form-group"><label class="col-sm-2 control-label">사후조정 </label>
	                <div class="col-sm-10">
	                	<label class="radio-inline">
							<input type="radio" name="stAdjust" id="m_stAdjust" value='Y' readonly="readonly"/>Y
						</label>
						<label class="radio-inline">
							<input type="radio" name="stAdjust" id="m_stAdjust" value='N' readonly="readonly"/>N
						</label>
	                </div>
	            </div>

	            <div class="form-group"><label class="col-sm-2 control-label">메모 </label>
	                <div class="col-sm-10"><textarea id="memo" name="memo" class="form-control" readonly="readonly"></textarea></div>
	            </div>
	         </div>
